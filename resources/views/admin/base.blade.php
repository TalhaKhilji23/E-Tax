            ...
            <div class="d-lg-flex d-none flex-column h-100 pt-3">
                <div class="p-2">
                    ...
                    <div class="d-flex justify-content-between flex-column" style="height: 86vh !important;">
                        <div class="dropdown">
                            <a href="#" class="d-flex align-items-center flex-column link-light text-decoration-none dropdown-toggle" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="/img/profile.png" alt="" width="100px" height="100px" class="rounded-circle me-2" />
        ...
        <div class="container-fluid col-xl-10 col-12">
            <div class="d-flex align-items-center">
                ...
                <div id="bars-button" class="d-block d-lg-none">
                    ...
                    <div class="offcanvas offcanvas-start" style="width: 280px" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
