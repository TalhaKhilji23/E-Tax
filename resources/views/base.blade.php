...
<body>
    <header>
        <nav class="navbar bg-transparent position-absolute p-0 max-p">
            <div class="container-fluid pt-3 d-flex justify-content-between">
                ...
                <div class="nav-toggler">
                    <button class="navbar-toggler m-3 mt-md-0 me-md-0 fixed-top ms-auto text-white" id="menu-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">
        ...
        <div class="offcanvas menu-body offcanvas-top h-100 text-white" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
            <div class="offcanvas-header">
                ...
                <button type="button" class="arrow-btn text-white bg-transparent border-secondary border rounded-circle mt-4 me-5" data-bs-dismiss="offcanvas" aria-label="Close">
